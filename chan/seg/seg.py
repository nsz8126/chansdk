...
from chan.common.enum import BI_DIR, MACD_ALGO, TREND_LINE_SIDE
from chan.common.exception import CChanException, ErrCode
from chan.kline.unit import CKLine_Unit
from chan.math.trend_line import CTrendLine
...
class CSeg(Generic[LINE_TYPE]):
    def __init__(self, idx: int, start_bi: LINE_TYPE, end_bi: LINE_TYPE, is_sure=True, seg_dir=None, reason="normal"):
        ...
        self.parent_seg: Optional[CSeg] = None  # 在哪个线段里�?
        ...
        self.bi_list: List[LINE_TYPE] = []  # 仅通过self.update_bi_list来更�?
        self.reason = reason
